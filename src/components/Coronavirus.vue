  ...
  <div class="container">
    ...
    <div class="row mt-5" v-if="arrHospitalized.length > 0">
      <div class="col">
        ...
        <line-chart
          :chart-data="arrHospitalized"
          :options="chartOptions"
          :chart-colors="hospitalizedChartColors"
          label="Hospitalized"
        />
      </div>
    </div>
    ...
    <div class="row mt-5" v-if="arrOnVentilators.length > 0">
      <div class="col">
        ...
        <line-chart
          :chart-data="arrOnVentilators"
          :options="chartOptions"
          :chart-colors="onVentilatorsColors"
    ...
    <div class="row mt-5" v-if="arrRecovered.length > 0">
      <div class="col">
        ...
        <line-chart
          :chart-data="arrRecovered"
          :options="chartOptions"
          :chart-colors="recoveredColors"
          label="Recovered"
        />
      </div>
    </div>
    ...
    <div class="row mt-5 mb-5">
      <div class="col">
        ...
        <line-chart
          ...
          :chart-data="arrDeaths"
          :options="chartOptions"
          :chart-colors="deathColors"
          label="Deaths"
        />
      </div>
    </div>
